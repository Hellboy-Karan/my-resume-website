...
⚠️ IMPORTANT: Sending your details is MANDATORY for the shortlisting process.

Candidates who do not send their details to the recruiter email IDs may not be considered for the next round of the selection process.

To avoid missing this opportunity, please send your details immediately after submitting the application form.
...
Please send your details to all the email addresses below:

• career@clinchedge.com
• career@atlysbridge.com

⏳ Limited profiles are being shortlisted. Early responses will be given priority.
